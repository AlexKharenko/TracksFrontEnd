<template>
  <div class="tracks-list-constainer">
    <h4>Tracks</h4>
    <div class="list-block">
      <h4 v-if="tracks.length == 0">No tracks</h4>
      <div class="list" v-if="tracks.length > 0">
        <div class="list-element" v-for="track in tracks" :key="track.track_id">
